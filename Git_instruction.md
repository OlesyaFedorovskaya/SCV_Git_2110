...
Добавить удаленный репозиторий к проекту можно так же командой:
```
git remote add <имя для репозитория><адрес репозитория>
```
Команда git remote позволяет создавать, просматривать и удалять подключения к другим репозиториям.

5. Выкачать (вытянуть) актуальное состояние из удаленного репозитория.
...
4. Чтобы отправить ваш локальный репозиторий или его изменения, в удаленный (на Github (при этом вам, возможно, нужно будет авторизоваться на удаленном репозитории)), необходимо использовать команду `git push`
